...
import { MOCK_APPS } from "../__mocks__/appData";
...
export const AppBlockerScreen: React.FC = () => {
  ...
  const { rules, appUsages } = useSelector(
    (state: RootState) => state.appBlocker
  );
  ...
  const totalScreenTime = appUsages.reduce(
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    selectedCategory === "all" ? "#fff" : theme.colors.text,
                },
              ]}
            >
              Alle
            ...
            >
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      selectedCategory === cat.key ? "#fff" : theme.colors.text,
                  },
                ]}
              >
                {cat.label}
